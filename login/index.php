...
//Execute the query
	...
	$sql = "INSERT INTO registered_users(first_name,last_name,address,city,zip,about,email,password)
				VALUES('$first_name','$last_name','$address','$city','$zip','$about','$email','$password')";
		...
		<div class="modal-dialog">
	    	<div class="modal-content login-modal">
	      		<div class="modal-header login-modal-header">
	        		...
	        		<h4 class="modal-title text-center" id="loginModalLabel">Egerton Internship Mgmt System</h4>
	      		</div>
